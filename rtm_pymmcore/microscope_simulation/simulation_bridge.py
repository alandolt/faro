"""Bridge connecting devices to the simulation."""
...
class SimulationBridge:
    """Bridge that connects devices to the simulation."""
    ...
    def snap(self, exposure: float, brightness: float, **kwargs) -> np.ndarray:
        ...
        return self._sim.snap_frame(
            mask=mask, exposure=exposure, intensity=brightness, **kwargs
        )
